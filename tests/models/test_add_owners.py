...
params = [
    ...
    [{'ACONDBS_OWNERS_GITHUB_LOGINS': "octocat,dojocat"}, {"octocat", "dojocat"}],
    [{'ACONDBS_OWNERS_GITHUB_LOGINS': "octocat  ,  dojocat"}, {"octocat", "dojocat"}],
    [{'ACONDBS_OWNERS_GITHUB_LOGINS': "octocat  ,  dojocat,, ,  octocat  "}, {"octocat", "dojocat"}],
]
...
def test_add_owners_to_db_as_admins(kwargs, expected, tmpdir_factory):
    ...
    kwargs.update(dict(
        SQLALCHEMY_DATABASE_URI=f'sqlite:///{tmp_database_path}'
    ))
