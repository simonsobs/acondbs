...
def app(app_empty):
    ...
    AttributeUnicodeText(product=map1, field=field1, value="value1")
    AttributeDate(product=map1, field=field2, value=datetime.date(2020, 2, 1))
    AttributeDateTime(
        product=map1,
        field=field3,
    ...
    AttributeUnicodeText(product=map2, field=field1, value="value2")
    AttributeDate(product=map2, field=field2, value=datetime.date(2020, 2, 10))
    AttributeDateTime(
        product=map2,
        field=field3,
    ...
    AttributeUnicodeText(product=map3, field=field1, value="value3")
    AttributeDate(product=map3, field=field2, value=datetime.date(2020, 3, 19))
    AttributeDateTime(
        product=map3,
        field=field3,
    ...
    AttributeUnicodeText(product=beam1, field=field1, value="value4")
    AttributeDate(product=beam1, field=field2, value=datetime.date(2020, 2, 5))
    AttributeDateTime(
        product=beam1,
        field=field3,
    ...
    AttributeUnicodeText(product=beam2, field=field1, value="value5")
    AttributeDate(product=beam2, field=field2, value=datetime.date(2020, 3, 4))
    AttributeDateTime(
        product=beam2,
        field=field3,
