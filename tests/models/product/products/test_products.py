...
def test_product(app_empty: Flask) -> None:
    app = app_empty
...
def test_constraint_type_required_add(app_empty: Flask) -> None:
    app = app_empty
...
def test_constraint_type_required_delete(app_empty: Flask) -> None:
    app = app_empty
...
def test_git_hub_user(app_empty: Flask) -> None:
    app = app_empty
