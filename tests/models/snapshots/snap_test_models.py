...
snapshots['test_models 1'] = {
    ...
    'product_types': GenericRepr("Table('product_types', MetaData(bind=None), Column('type_id', Integer(), table=<product_types>, primary_key=True, nullable=False), Column('name', Text(), table=<product_types>, nullable=False), Column('indef_article', Text(), table=<product_types>), Column('singular', Text(), table=<product_types>), Column('plural', Text(), table=<product_types>), Column('icon', Text(), table=<product_types>), schema=None)"),
