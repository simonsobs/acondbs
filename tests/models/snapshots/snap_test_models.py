...
snapshots['test_models 1'] = {
    ...
    'product_relation_types': GenericRepr("Table('product_relation_types', MetaData(bind=None), Column('type_id', Integer(), table=<product_relation_types>, primary_key=True, nullable=False), Column('name', Text(), table=<product_relation_types>, nullable=False), Column('reverse_type_id', Integer(), ForeignKey('product_relation_types.type_id'), table=<product_relation_types>), schema=None)"),
    'product_relations': GenericRepr("Table('product_relations', MetaData(bind=None), Column('relation_id', Integer(), table=<product_relations>, primary_key=True, nullable=False), Column('type_id', Integer(), ForeignKey('product_relation_types.type_id'), table=<product_relations>, nullable=False), Column('self_product_id', Integer(), ForeignKey('products.product_id'), table=<product_relations>), Column('other_product_id', Integer(), ForeignKey('products.product_id'), table=<product_relations>), Column('reverse_relation_id', Integer(), ForeignKey('product_relations.relation_id'), table=<product_relations>), schema=None)"),
