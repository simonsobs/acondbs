...
params = [
    pytest.param(
        '''
        mutation m {
          updateSimulation(productId: 1001, input: {
              contact: "new-contact",
              updatedBy: "updater",
              note: "- updated note 123"
          }) {
            simulation { productId name } }
        }
         ''',
        '''
          {
...
params = [
    pytest.param(
        '''
        mutation m {
          updateSimulation(productId: 1010, input: {
              name: "new-name"
          }) {
            simulation { productId name } }
        }
        ...
        ''',
        id='updateSimulation-error-immutable-fields'
    ),
]
